...
def describe_dataset():
    ...
    Our dataset named <strong><em>"student_info.csv"</em></strong> Provides comprehensive details about the students of a private Montessori school, capturing various aspects that span from 
    ...
    The dataset was downloaded from the school's CRM system. Initially, we started with two separate datasets: one containing student enrollment information 
    and the other containing financial records, such as billing plans and monthly invoice details.
